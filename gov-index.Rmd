...
index_joined <- gdi_selected %>% 
  ...
  select(country, gov_effectiveness, q14_steering_capability, icrg_qog, qs_impar, functioning_of_government) %>% 
...
index_joined %>% 
  ...
  mutate(category = fct_recode(category, 
                               ...
                               "ICRG" = "icrg_qog", 
                               "QOG" = "qs_impar"), 
         category = fct_relevel(category, "WGI", "ICRG", "BTI", "QOG", "EIU")) %>% 
  ...
  annotate("text", x = -.72, y = 5.2, label = "Functioning of government", color = "black", family = "Times")
