...
## Our core dataset: Load and clean owid-covid19-dataset
...
covid_owid_joined %>% 
  ...
  labs(title = "Figure 2. Total number of confirmed cases and mortality rate", 
  ...
  theme(text = element_text(family = "Times"), 
        plot.title = element_text(face = "bold", size = 15)) 
ggsave(filename = "figs/total_cases_mortality_rate.pdf", width = 8, height = 5)
...
covid_owid_joined %>% 
  ...
  scale_x_date(date_breaks = "2 month", 
               date_labels = "%y-%m", 
               expand = c(0, 0)) +
  labs(title = "Figure 1. Comparing the trend in the daily total of confirmed cases",
...
ggsave(filename = "figs/comparing-stringency-of-crisis-response.pdf", width = 8, height = 5)
